  ...
  return (
    <>
      <div className="sticky bg-[#f7f9fa] top-0 w-full h-[90px] flex justify-around md:justify-evenly items-center">
        <NavLink to={"/"}>
          <h1 className="font-bold text-2xl">Magazine</h1>
        </NavLink>
        ...
        <button
          onClick={toggle}
          className="block md:hidden p-1.5 rounded-md border border-slate-900 hover:shadow-md hover:shadow-black "
        >
      ...
      <div
        className={`${
          open ? "hidden" : "flex"
        } sticky top-[80px] gap-5 w-[100%] bg-transparent backdrop-blur-sm p-5 justify-start flex-col items-center`}
      >
        <NavLink
        ...
        <div className="flex flex-wrap justify-around items-center gap-3">
          ...
          <NavLink onClick={() => setOpen(!open)} to={"cart"}>
            <button
              className="ease-out duration-300 hover:bg-[#181819] hover:text-white flex justify-around items-center gap-3 h-10 px-3  rounded-md border border-slate-900 hover:shadow-md hover:shadow-black text-slate-900"
              type="button"
            >
